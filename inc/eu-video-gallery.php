...
function hsinsider_video_gallery() {
	...
	if ( $the_query->have_posts() ) :
		...
		if( !empty( $videos ) ) :
			...
			$gallery .=	'		<div class="video col-md-9"><div class="iframe-wrapper"><iframe id="player" type="text/html" width="640" height="390" src="http://www.youtube.com/embed/' . $videos[0]['youtube_id'] . '?enablejsapi=1&origin=' . esc_url( home_url() ) . '" frameborder="0"></iframe></div></div>';
			...
			$gallery .= '		</div>';
			$gallery .= '	</div>';
			$gallery .= '  <div id="video-carousel" class="carousel slide" data-ride="carousel"><!-- Indicators -->
